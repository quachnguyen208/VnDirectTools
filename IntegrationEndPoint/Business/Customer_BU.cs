...
{
    public class Customer_BU
    {
        public class API
        {
            public static T POST<T>(string url, Object.Customer_Request obj) where T : class
            {
                T item = null;
                string postData = "";
                string result = "";
                ...
                {
                    Utilities.FileLog.WriteFileLog("API-->Customer-->Customer::Data" + Environment.NewLine + postData);
                    Utilities.FileLog.WriteFileLog("API-->Customer-->POST::" + ex.Message);
                }
                return item;
            }
        }
