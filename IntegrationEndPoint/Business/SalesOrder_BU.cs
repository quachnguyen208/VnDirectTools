...
{
    public class SalesOrder_BU
    {
        public class API
        {
            public static T POST<T>(string url, Object.SalesOrder_Request obj) where T : class
            {
                T item = null;
                string postData = "";
                string result = "";
                ...
                {
                    Utilities.FileLog.WriteFileLog("API-->SalesOrder-->SalesOrder::Data" + Environment.NewLine + postData);
                    Utilities.FileLog.WriteFileLog("API-->SalesOrder-->POST::" + ex.Message);
                }
                return item;
            }
        }
